package com.aptoide.amethyst.remoteinstall;
                    ...
                    jmDNS.addServiceListener(SERVICE_TYPE, new ServiceListener() {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    RemoteInstallationSenderManager.
                                            this.listener.onAptoideTVServiceLost(new ReceiverDevice(fName, address, port));
                                }
                            });
                        ...
                        public void serviceResolved(ServiceEvent event) {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    RemoteInstallationSenderManager.
                                            this.listener.onAptoideTVServiceFound(new ReceiverDevice(fName, address, port));
                                }
                            });
                        }
                    });
