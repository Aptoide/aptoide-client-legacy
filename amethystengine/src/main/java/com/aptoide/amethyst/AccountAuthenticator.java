...
import static com.aptoide.amethyst.configuration.AptoideConfiguration.AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS;
import static com.aptoide.amethyst.configuration.AptoideConfiguration.AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS_LABEL;
import static com.aptoide.amethyst.configuration.AptoideConfiguration.AccountGeneral.AUTHTOKEN_TYPE_READ_ONLY;
import static com.aptoide.amethyst.configuration.AptoideConfiguration.AccountGeneral.AUTHTOKEN_TYPE_READ_ONLY_LABEL;
...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        ...
        final Intent intent = new Intent(mContext, Aptoide.getConfiguration().getLoginActivity());
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        // return an error
        if (!authTokenType.equals(AptoideConfiguration.AccountGeneral.AUTHTOKEN_TYPE_READ_ONLY) && !authTokenType.equals(AptoideConfiguration.AccountGeneral.AUTHTOKEN_TYPE_FULL_ACCESS)) {
