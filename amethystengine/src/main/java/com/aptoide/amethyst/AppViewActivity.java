...
public class AppViewActivity extends AptoideBaseActivity implements AddCommentVoteCallback, FlagApkDialog.ApkFlagCallback {
    ...
    private static final String SUBSCRIPTION_ARG_KEY = "subscriptionResult";
    ...
    protected void onRestart() {
        ...
        args.putBoolean(SUBSCRIPTION_ARG_KEY,subscriptionResult);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode){
            case SubscriptionActivity.SUBSCRIPTION_REQ_CODE:
        ...
        public void onCreate(@Nullable final Bundle savedInstanceState) {
            ...
            if (savedInstanceState != null) {
                ...
                if(getArguments() != null){
                    forceAutoDownload = forceAutoDownload || getArguments().getBoolean(SUBSCRIPTION_ARG_KEY,false);
                }
            }
        }
...
//                    UpdateAppVersionInstalled(info.versionName);
        ...
        private void download() {
            if(Subscription.showOnDownload(isPaidApp())){
                Subscription.subscriptionTokenVerificationRequest(spiceManager, Subscription.getAccessToken(), new RequestListener<SubscriptionStatus>() {
                    @Override
                    public void onRequestFailure(SpiceException spiceException) {
                        Subscription.showSubscriptionPage(getActivity());
                    }
