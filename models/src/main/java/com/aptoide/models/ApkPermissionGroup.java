...
public class ApkPermissionGroup {
     ...
     * Could be refactored to check if the permissions' list is the same.
     *
     * @param o
     * @return
     */
    ...
    public boolean equals(Object o) {
        return o instanceof ApkPermissionGroup && this.getName().equals(((ApkPermissionGroup) o).getName()) && this.descriptions.size() == ((ApkPermissionGroup) o).descriptions.size();
    }
}
