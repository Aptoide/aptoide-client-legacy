...
import cm.aptoide.pt.MoreSearchActivity;
        ...
        switch (viewHolder.viewType) {
            ...
            case R.layout.search_app_row:
                ...
                try {
                    ...
                    if (modified != null) {
                        String timeSinceUpdate= AptoideUtils.DateTimeUtils.getInstance(item.itemView.getContext()).getTimeDiffAll(item.itemView.getContext(), modified.getTime());
