package cm.aptoide.pt.adapter.store;
...
import cm.aptoide.pt.viewholders.main.CommentHeaderViewHolder;
...
public class CommentsStoreAdapter extends BaseAdapter implements SpannableRecyclerAdapter {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case R.layout.row_appview_comments_header: {
            ...
            case R.layout.row_appview_create_comment: {
    ...
    public void onBindViewHolder(BaseViewHolder viewHolder, int position) {
        ...
        switch (viewHolder.viewType) {
            // specific header for the AppView
            case R.layout.row_appview_comments_header: {
            ...
            case R.layout.comment_row: {
                ...
                if (appView) {
                    ...
                    item.replyComment.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (AptoideUtils.AccountUtils.isLoggedInOrAsk(activity)) {
                                ReplyCommentDialog replyDialog = AptoideDialog.replyCommentDialog(commentItem.id.intValue(), commentItem.username, addCommentCallback);
                                replyDialog.show(((AppCompatActivity) activity).getSupportFragmentManager(), "replyCommentDialog");
                            }
                        }
                    });
                ...
                viewHolder.itemView.setOnClickListener(new BaseAdapter.CommentItemOnClickListener(commentItem));
                Glide.with(context).load(commentItem.useravatar)
                        .transform(new CircleTransform(context)).into(item.useravatar);
