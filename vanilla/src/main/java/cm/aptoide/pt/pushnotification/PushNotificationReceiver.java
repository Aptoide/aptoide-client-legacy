package cm.aptoide.pt.pushnotification;
...
import cm.aptoide.pt.services.TimelineActivitySyncService;
import cm.aptoide.pt.services.TimelinePostsSyncService;
...
//            Log.d("PushNotificationReceiver", "is 16 or more, BIG!!!");
            RemoteViews expandedView = new RemoteViews(context.getPackageName(),
                    cm.aptoide.pt.R.layout.pushnotificationlayout);
            expandedView.setBitmap(cm.aptoide.pt.R.id.PushNotificationImageView, "setImageBitmap", o);
            expandedView.setImageViewBitmap(cm.aptoide.pt.R.id.icon, BitmapFactory.decodeResource(context.getResources(), getDrawableResource()));
            expandedView.setTextViewText(cm.aptoide.pt.R.id.text1, extra.getCharSequence(PUSH_NOTIFICATION_TITLE));
            expandedView.setTextViewText(cm.aptoide.pt.R.id.description, extra.getCharSequence(PUSH_NOTIFICATION_MSG));
